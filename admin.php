...
<body>
	...
	<div>
	 ...
	 password=597dac569edc9b06099f1027652ff9aab479d2d6c501e71e1c31adc6bd6ed453 dbname=d621ll97foi9ku");
		$sql = "DELETE FROM products WHERE productid=".$_POST['del'];
...
foreach ($resultSet as $row) {
	...
	?><td><form action="" method="POST">
					<button class="function" onclick="return Deleteqry(<?php echo $rows1['productid'] ?>)"><img src="img/rubbish-bin-delete-button.png" alt=""></button></form></td><?php
	echo "</tr>";
}
	echo "</table>";
?>
